...
| Worktree setup failed | Git state or path constraints prevented isolated worktree creation. | Clean conflicting state, avoid per-task cwd overrides, or retry without `worktree:true`. |
