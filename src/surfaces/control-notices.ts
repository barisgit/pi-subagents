...
export function registerControlNotices(params: { pi: ExtensionAPI; isChildSession: boolean; globalStore: Record<string, unknown> }): { controlEventHandler: (payload: unknown) => void } {
