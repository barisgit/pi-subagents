...
- `parseWorkflowMeta` clones validated metadata into host-owned plain objects, trims display strings, rejects C0/C1 controls with field-specific errors, canonicalizes phase prefixes, and rejects duplicate canonical phase titles.
