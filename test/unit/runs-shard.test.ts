...
import { appendRunEntry, getShardPath, readAllEntries, readShardEntries, setRegistryPathForTests, type RunsRegistryEntry } from "../../src/state/runs-registry.ts";

const tmpRoots: string[] = [];
let registryPath = "";

function entry(runId: string, startedAt: number, lineage: Partial<Pick<RunsRegistryEntry, "rootSessionId" | "parentSessionId">> = {}): RunsRegistryEntry {
	return {
		runId,
